...
module Interactiff
  class Application < Rails::Application
    ...
    config.autoload_paths += Dir["#{config.root}/app/models/blocks", "#{config.root}/app/models/blocks/**/", "#{config.root}/lib"]
    ...
    config.assets.precompile += %w(admin.js admin.css play.css play.js timeline.js embed.js)
